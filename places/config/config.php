 ...
 * BASIC
 */
 $config['site_title'] = 'Lost in the Myths of Time';              // Site title
 $config['base_url'] = 'http://web.stanford.edu/group/texttechnologies/cgi-bin/stanfordnottingham/places';                    // Override base URL (e.g. http://example.com)
